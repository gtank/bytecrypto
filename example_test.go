...
import (
	...
	"github.com/gtank/bytecrypto/asn1"
)
...
func ExampleString_aSN1() {
	...
	input := bytecrypto.String([]byte{0x30, 12, 0xa6, 3, 2, 1, 2, 4, 5, 'h', 'e', 'l', 'l', 'o'})

	var (
		version                   int64
		data, inner, versionBytes bytecrypto.String
		haveVersion               bool
	)
...
func ExampleBuilder_aSN1() {
	...
	var b bytecrypto.Builder
	b.AddASN1(asn1.SEQUENCE, func(b *bytecrypto.Builder) {
		if version != defaultVersion {
			b.AddASN1(asn1.Tag(6).Constructed().ContextSpecific(), func(b *bytecrypto.Builder) {
...
func ExampleBuilder_lengthPrefixed() {
	...
	var b bytecrypto.Builder
	b.AddUint16LengthPrefixed(func(b *bytecrypto.Builder) {
		for _, value := range input {
			b.AddUint8LengthPrefixed(func(b *bytecrypto.Builder) {
...
func ExampleBuilder_lengthPrefixOverflow() {
	...
	// Output: len=0 err=bytecrypto: pending child length 256 exceeds 1-byte length prefix
}
...
func ExampleBuilderContinuation_errorHandling() {
	...
	b.AddUint16LengthPrefixed(func(b *bytecrypto.Builder) {
		b.AddUint32(0)
		panic(bytecrypto.BuildError{Err: errors.New("example error")})
	})
